...
class ContactViewController: UIViewController {
    ...
    //PT-BR => Variavel para facilitar no uso do ID da xib
    //EN => variable just to help using the ID of my xib cell
    ...
    //MARK: Return to main VC
    //EN => func do botão para retornar para 1 ViewController
    ...
    //EN => func to validade if a contact already exist in the contactList
    ...
    */
    ...
    /*
     ...
     3. User click in 'Remover contato'(Delete Contact), and the app remove the contact 'Lucas,123', ignoring the infos write in the textFields
